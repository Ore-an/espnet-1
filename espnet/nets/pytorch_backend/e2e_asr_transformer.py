...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward(self, xs_pad, ilens, ys_pad, *langs):
        """E2E forward.
    ...
    def calculate_all_attentions(self, xs_pad, ilens, ys_pad, *langs):
    ...
    def calculate_all_ctc_probs(self, xs_pad, ilens, ys_pad, *langs):
