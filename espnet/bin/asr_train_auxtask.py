...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument("--aux_dict", required=required,
                        help="Dictionary for auxiliary output")
    ...
    #     type=str,
    #     default=None,
    #     help="Filename of train label data (json) for auxiliary output",
    # )
    # parser.add_argument(
    #     "--aux-valid-json",
    #     type=str,
    #     default=None,
    #     help="Filename of validation label data (json) for auxiliary output",
    # )
    ...
    parser.add_argument("--penalty", default=0.0,
                        type=float, help="Incertion penalty")
    parser.add_argument(
        "--maxlenratio",
        default=0.0,
        type=float,
    ...
    parser.add_argument("--lm-weight", default=0.1,
                        type=float, help="RNNLM weight.")
    parser.add_argument("--sym-space", default="<space>",
                        type=str, help="Space symbol")
    parser.add_argument("--sym-blank", default="<blank>",
                        type=str, help="Blank symbol")
    # minibatch related
    parser.add_argument(
        "--sortagrad",
        default=0,
    ...
    parser.add_argument("--uttmvn-norm-means",
                        type=strtobool, default=True, help="")
    parser.add_argument("--uttmvn-norm-vars",
                        type=strtobool, default=False, help="")
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.asr.pytorch_backend.asr_auxtask import train
            train(args)
        else:
